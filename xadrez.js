...
function moverCavalo(pecaAnalisada, elementoDestino) {
    ...
    if ( // valida o movimento do cavalo dois quadrantes para direita e um quadrante para baixo
        numVetorColunaQuadrante == (numVetorColunaPeca + 2) &&
        numVetorLinhaQuadrante == (numVetorLinhaPeca + 1)
    ) {
    ...
    if ( // valida o movimento do cavalo dois quadrantes para esquerda e um quadrante para cima
        numVetorColunaQuadrante == (numVetorColunaPeca - 2) &&
        numVetorLinhaQuadrante == (numVetorLinhaPeca - 1)
    ) {
    permitirMovimento = true;
    ...
    if ( // valida o movimento do cavalo dois quadrantes para esquerda e um quadrante para baixo
        numVetorColunaQuadrante == (numVetorColunaPeca - 2) &&
        numVetorLinhaQuadrante == (numVetorLinhaPeca + 1)
) {
permitirMovimento = true;
...
if ( // valida o movimento do cavalo dois quadrantes para baixo e um quadrante para direita
    numVetorColunaQuadrante == (numVetorColunaPeca + 1) &&
    numVetorLinhaQuadrante == (numVetorLinhaPeca + 2)
){
    permitirMovimento = true;
    ...
    if ( // valida o movimento do cavalo dois quadrantes para baixo e um quadrante para esquerda
        numVetorColunaQuadrante == (numVetorColunaPeca - 1) &&
        numVetorLinhaQuadrante == (numVetorLinhaPeca + 2)
) {
permitirMovimento = true;
